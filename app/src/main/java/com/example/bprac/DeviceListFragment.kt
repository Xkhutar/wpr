...
import com.example.bprac.DeviceListFragment.WiFiPeerListAdapter
...
import com.example.bprac.DeviceListFragment
...
class DeviceListFragment : ListFragment(), PeerListListener {
    ...
    ) : ArrayAdapter<WifiP2pDevice?>(context, textViewResourceId, objects) {
